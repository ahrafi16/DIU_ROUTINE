      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        <div className="hidden md:block w-64 bg-[#29303d] p-6 space-y-4">
          ...
          <button
            ...
            className={`w-full text-left px-4 py-2 rounded hover:bg-purple-600 ${activeSection === 'teacher' ? 'bg-purple-700 font-semibold' : ''
              }`}
          >
            Teacher
          </button>
          <button
            ...
            className={`w-full text-left px-4 py-2 rounded hover:bg-pink-600 ${activeSection === 'empty' ? 'bg-pink-700 font-semibold' : ''
              }`}
          >
            Empty Room
          </button>
        ...
        <div className="md:hidden flex flex-col w-full">
          ...
          {/* Bottom Nav */}
          <div className="fixed bottom-0 left-0 right-0 bg-[#2b2f3a] text-white shadow-lg flex justify-around gap-1 items-center h-14 md:hidden">
            <button
              onClick={() => setActiveSection('routine')}
              className={`flex-1 text-center rounded-2xl py-3 text-sm font-medium transition ${activeSection === 'routine' ? 'bg-indigo-600 font-semibold' : 'hover:bg-[#3b3f4a]'
                }`}
            >
              Routine
            </button>
            <button
              onClick={() => setActiveSection('teacher')}
              className={`flex-1 text-center rounded-2xl py-3 text-sm font-medium transition ${activeSection === 'teacher' ? 'bg-purple-600 font-semibold' : 'hover:bg-[#3b3f4a]'
                }`}
            >
              Teacher
            </button>
            <button
              onClick={() => setActiveSection('empty')}
              className={`flex-1 text-center rounded-2xl py-3 text-sm font-medium transition ${activeSection === 'empty' ? 'bg-pink-600 font-semibold' : 'hover:bg-[#3b3f4a]'
                }`}
            >
              Empty Room
            </button>
