...
const TeacherCard = ({ teacherInitial }) => {
    ...
    return (
        <div className="mt-6 p-4 bg-gray-800 text-white rounded-xl shadow max-w-5xl mx-auto">
            {error ? (
                    ...
                    <div className="flex gap-6 items-center mb-6">
                        {info.teacher_info?.image_url ? (
                            <img
                                ...
                                className="w-32 h-32 md:m-3 object-cover rounded-full border"
                            />
                        ) :
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-36 text-gray-500">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                            </svg>

                        }
                        <div className="flex flex-col gap-0.5">
                            <h2 className="text-2xl font-bold mb-2">{info.teacher_info?.name}</h2>
